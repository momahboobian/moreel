      ...
      <ul className="ml-1 mt-8 flex items-center" aria-label="Social media">
        <li className="mr-5 text-xs">
          <a
            ...
            href="https://github.com/momahboobian"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <li className="mr-5 text-xs">
          <a
            className="block hover:text-slate-200"
            href="https://instagram.com/mo.mahboobian/"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <li className="mr-5 text-xs">
          <a
            className="block hover:text-slate-200"
            href="https://twitter.com/momahboobian/"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <li className="mr-5 text-xs">
          <a
            className="block hover:text-slate-200"
            href="https://www.linkedin.com/in/mo-mahboobian/"
            target="_blank"
            rel="noreferrer"
          >
