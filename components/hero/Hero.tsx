...
export default function Hero() {
  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-40 flex items-start justify-center p-2 z-50">
        <section className="flex flex-col md:flex-row justify-between items-center mt-3 md:mt-20 bg-secondary-dark text-white rounded-2xl">
          ...
          >
            ...
            <p className="font-normal text-m md:text-base lg:text-lg py-6 max-w-4xl ">
              ...
              coding and visual storytelling. Adapting to evolving circumstances
              and mastering new technologies are among my strengths. <br />
